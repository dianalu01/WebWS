...
public interface AdmazingPortType {
    ...
    @WebMethod
    @WebResult(name = "getByIdCuponeraResponse", targetNamespace = "http://admazing.com/", partName = "parameters")
    public GetByIdCuponeraResponse getByIdCuponera(
        @WebParam(partName = "parameters", name = "getByIdCuponeraRequest", targetNamespace = "http://admazing.com/")
        GetByIdCuponeraRequest parameters
    );
