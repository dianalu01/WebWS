...
public interface AdmazingPortType {
    ...
    @WebMethod
    @WebResult(name = "getAllCategoriesResponse", targetNamespace = "http://admazing.com/", partName = "parameters")
    public GetAllCategoriesResponse getAllCategories(
        @WebParam(partName = "parameters", name = "getAllCategoriesRequest", targetNamespace = "http://admazing.com/")
        GetAllCategoriesRequest parameters
    );
