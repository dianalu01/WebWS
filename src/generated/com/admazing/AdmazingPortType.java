...
public interface AdmazingPortType {
    ...
    @WebMethod
    @WebResult(name = "getPromotionDetailedResponse", targetNamespace = "http://admazing.com/", partName = "parameters")
    public GetPromotionDetailedResponse getPromotionDetailed(
        @WebParam(partName = "parameters", name = "getPromotionDetailedRequest", targetNamespace = "http://admazing.com/")
        GetPromotionDetailedRequest parameters
    );
